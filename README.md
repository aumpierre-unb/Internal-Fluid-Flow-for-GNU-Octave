...
![Illustrative graphical output](https://github.com/aumpierre-unb/Internal-Fluid-Flow-for-GNU-Octave/blob/main/pics/D2fRe2.pdf "Example of graphical output, from hydraulic diameter and head loss to Re and f")
