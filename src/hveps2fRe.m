...
function [Re,f]=hveps2fRe(h,v,L,rr,g,mu,rho,s=0)
    # [Re,f]=hveps2fRe(h,v,L,rr,g,mu,rho[,s]) computes
    ...
    # h=40;v=110;L=2500;rr=0.0025;g=981;mu=.0089;rho=.989;
    # [Re,f]=hveps2fRe(h,v,L,rr,g,mu,rho)
    # D=Re*mu/rho/v
    # thk=rr*D
    # Q=v*(pi/4*D^2)
    #
